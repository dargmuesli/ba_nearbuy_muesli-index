import type { NearbuyPluginOptions } from '@ninjaneers/nearbuy-web-plugins'
...
const nearbuyPluginMuesliIndex: NearbuyPluginOptions = {
  ...
  versionNearbuyCompatibility: '',
  url: new URL('http://localhost:3001'), // eslint-disable-line compat/compat
  iconPngBase64:
